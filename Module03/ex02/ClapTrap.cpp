...
void ClapTrap::takeDamage(unsigned int amount) {
    ...
    if (amount >= HitPoints) {
        HitPoints = 0;
        std::cout << "ClapTrap " << name << " a subi " << amount << " points de dégâts" << std::endl;
        std::cout << "ClapTrap " << name << " a perdu. Nombres de points de vie : " << HitPoints << std::endl;
    } else {
        HitPoints -= amount;
        std::cout << "ClapTrap " << name << " a subi " << amount << " points de dégâts, points de vie restants : " << HitPoints << std::endl;
    }
